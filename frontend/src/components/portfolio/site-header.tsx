...
export function SiteHeader() {
  return <header className="site-header">
    ...
    <details className="mobile-navigation">
      ...
      <nav aria-label="Navigation mobile"><Link href="/projets">Projets</Link><Link href="/competences">Stack</Link><Link href="/parcours">Parcours</Link><Link href="/contact">Contact</Link></nav>
    </details>
  </header>;
}
