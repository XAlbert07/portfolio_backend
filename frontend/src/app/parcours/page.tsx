...
export const metadata: Metadata = { title: "Parcours", description: "Le parcours académique et les étapes qui ont construit le profil de développeur full-stack d’Albert Sama.", alternates: { canonical: "/parcours" } };
