...
export default async function AdminPathPage() { if (!(await cookies()).get("portfolio_admin_token")?.value) redirect("/admin/login"); return <main className="inner-page admin-page"><AdminBackLink /><p className="eyebrow">Administration · Parcours</p><h1>Gérer le parcours.</h1><p className="page-lead">Organise les étapes de ton parcours académique et les matières étudiées.</p><AcademicPathManager initialPath={await getPath()} /></main>; }
