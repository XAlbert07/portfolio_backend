...
export default async function AdminTechnologiesPage() { if (!(await cookies()).get("portfolio_admin_token")?.value) redirect("/admin/login"); return <main className="inner-page admin-page"><p className="eyebrow">Administration · Technologies</p><h1>Gérer la stack.</h1><p className="page-lead">Maintiens les technologies affichées sur le portfolio et associées aux projets.</p><TechnologyManager initialTechnologies={await getTechnologies()} /></main>; }
